...
router.get("/:username", ensureUserRights, async function (req, res, next) {
  try {
...
router.patch("/:username", ensureUserRights, async function (req, res, next) {
  try {
...
router.delete("/:username", ensureUserRights, async function (req, res, next) {
  try {
